...
#include <memory>
#include "../../TrafficSimulator/trafficlight.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TrafficLight_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TrafficLight_t qt_meta_stringdata_TrafficLight = {
    {
QT_MOC_LITERAL(0, 12), // "TrafficLight"
QT_MOC_LITERAL(13, 5), // "Blink"
QT_MOC_LITERAL(19, 0) // ""

    },
    "TrafficLight\0Blink\0"
};
...
const QMetaObject TrafficLight::staticMetaObject = { {
    ...
    qt_meta_stringdata_TrafficLight.offsetsAndSize,
    qt_meta_data_TrafficLight,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TrafficLight_t
...
void *TrafficLight::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "MapItem"))
        return static_cast< MapItem*>(this);
